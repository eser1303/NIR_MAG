...
\begin{frame}{Индикация проблем}	
	\begin{block}{Визуализация для пользователя}
	...
	\caption{Градиент с шагом в год}
...
\begin{block}{Полученные результаты}
	\begin{itemize}
		\item Разработано несколько методов прогнозирования даты фактической готовности объектов жилищного строительства
